...
class UAB_Admin_Settings {
	...
	public function register_settings() {
		...
		add_settings_field(
			'enable_author_box',
			'Enable Author Box',
			array( $this, 'enable_author_box_callback' ),
			'ultimate-author-box',
			'uab_main_settings'
		);
		...
		add_settings_field(
			...
			array( $this, 'author_position_callback' ),
			'ultimate-author-box',
			'uab_main_settings'
		);
		...
		add_settings_field(
			'box_position',
			'Bio Box Position',
			array( $this, 'box_position_callback' ),
			'ultimate-author-box',
			'uab_main_settings'
		);
		...
		add_settings_field(
			...
			array( $this, 'paragraph_number_callback' ),
			'ultimate-author-box',
			'uab_main_settings'
		);
	}
	...
	public function register_style_settings() {
		...
		add_settings_field(
			'author_image_width',
			'Author Image Width',
			array( $this, 'author_image_width_callback' ),
			'uab-elements-style',
			'uab_style_settings'
		);
		...
		add_settings_field(
			...
			array( $this, 'typography_callback' ),
			'uab-elements-style',
			'uab_style_settings'
		);
	...
	public function enable_author_box_callback() {
		$options = get_option( 'uab_settings', array() ); // Ensure $options is an array
	...
	public function box_position_callback() {
		$options   = get_option( 'uab_settings' );
		$positions = array( 'before', 'inside', 'after' );
	...
	public function paragraph_number_callback() {
		$options   = get_option( 'uab_settings', array() );
